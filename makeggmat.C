...
//TString rootfile="../decay46_124_all.root"; // Name of input file
//TString ggfile="46_124gg200s.root"; // Name of output file

void makeggmat(Double_t dtmin =0, Double_t dtmax=200, Double_t ctmax=50, TString rootfile = "/home/zhouzhenxiang/EuricaData/decay46_124_all.root",TString ggfile="46_124gg200s.root")
{
  int nebin=2500;//number of bin for TH2I
  double emax=2500;//maximum energy .
  /*double dtmin=0;//min. of decaytime
  double dtmax=200;//max. of decaytime.
  double ctmax=50;//coincidence time width*/
