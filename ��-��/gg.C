...
//TString fname="46_122gg600s.root";//filename;
TString fname="46_123gg600s.root";//filename;
//TString fname="pd123_300_600_delayMat_Lcut_asys.root";//filename;
...
//TString gx(double ge,int icy1=1);//
//TString gy(double ge,int icy1=1);//
...
//void gmx(double ge1,double ge2=0,double ge3=0,double ge4=0,double ge5=0,double ge6=0);
//void gmy(double ge1,double ge2=0,double ge3=0,double ge4=0,double ge5=0,double ge6=0);
